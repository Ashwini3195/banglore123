...
class HousePrice():
    ...
    def load_model(self):
        with open(r"C:\Users\HP\Abhipython\practice\\1. Linear reg model train\banglore_house_pred\Models\LR_Model.json",'r') as f:
            self.json_dict=json.load(f)

        with open(r"C:\Users\HP\Abhipython\practice\\1. Linear reg model train\banglore_house_pred\Models\LR_Model.pkl",'rb') as f:
